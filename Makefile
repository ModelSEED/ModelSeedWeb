# This Makefile is for the ModelSEEDWeb extension to perl.
#
...
#     NAME => q[ModelSEEDWeb]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML=>q[0], Dancer=>q[1.3072] }
#     VERSION_FROM => q[lib/ModelSEEDWeb.pm]
#     clean => { FILES=>q[ModelSEEDWeb-*] }
...
MAKE = make
FULLEXT = ModelSEEDWeb
BASEEXT = ModelSEEDWeb
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/ModelSEEDWeb.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/ModelSEEDWeb.pm

PM_TO_BLIB = lib/ModelSEEDWeb.pm \
	blib/lib/ModelSEEDWeb.pm
...
DISTNAME = ModelSEEDWeb
DISTVNAME = ModelSEEDWeb-0.1
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               ModelSEEDWeb' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Dancer:      1.3072' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dancer::" VERSION="1.3072" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/ModelSEEDWeb.pm blib/lib/ModelSEEDWeb.pm 
